...
// import 'package:flutter_stock_trading_app_clone/AppUtils/app_strings.dart';
// import 'package:flutter_stock_trading_app_clone/Model/stock_model.dart';
// import 'package:flutter_stock_trading_app_clone/Presentation/Widgets/news_card_widget.dart';
  ...
  Widget _buildBottomNavBar() {
    return Container(
      ...
      child: Row(
        children: [
          Padding(
            padding: EdgeInsets.only(bottom: 25.0, left: 20),
            child: SizedBox(
              width: 125,
              child: Image.asset(
                "assets/yahoo.png",
                    ...
                    children: [
                      PullDownButton(
                        itemBuilder: (context) => [
                          PullDownMenuItem(
                            onTap: () {},
                            title: AppStrings.mySymbol,
                          ),
                          const PullDownMenuDivider.large(),
                          PullDownMenuItem(
                            title: AppStrings.newList,
                            onTap: () {},
